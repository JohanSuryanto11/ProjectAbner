...
public class DataPabrik extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblPabrik = new javax.swing.JTable();
        ...
        setTitle("Data Pabrik");

        tblPabrik.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "IdPabrik", "NamaPabrik", "Alamat", "NoTelepon"
            }
        ) {
        ...
        jScrollPane1.setViewportView(tblPabrik);
        ...
        cmbCari.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "IdPabrik", "NamaPabrik", "Alamat", "NoTelepon", " " }));
    ...
    private void btnInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInputActionPerformed
        FrmInputPabrik ip = new FrmInputPabrik();
        ip.setVisible(true);
    }//GEN-LAST:event_btnInputActionPerformed

    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        FrmInputPabrik ip = FrmInputPabrik.getInstance();
        
        if(tblPabrik.getSelectedRow()<0){
            JOptionPane.showMessageDialog(this, "pilih data dulu");
        }
        else{
            ip.setVisible(true);
            String IdBarang = String.valueOf(tblPabrik.getValueAt(tblPabrik.getSelectedRow(), 0));
    ...
    private void btnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariActionPerformed
        if (!txtCari.getText().trim().equalsIgnoreCase("")) {
            ...
            tableHeader.add("IdPabrik");
            tableHeader.add("NamaPabrik");
            ...
            Vector tableData = p.LookUp(cmbCari.getSelectedItem().toString(),
                    txtCari.getText());
            if (tableData != null) {
                tblPabrik.setModel(new DefaultTableModel(tableData, tableHeader));
                DefaultTableCellRenderer renderer = new DefaultTableCellRenderer();
                renderer.setHorizontalAlignment(JLabel.RIGHT);
                if (tblPabrik.getRowCount() > 0) {
                    klikAwal();
                    tblPabrik.grabFocus();
                    cari = 0;
                    kodeCari = String.valueOf(tblPabrik.getValueAt(0, 0));
                } else {
                    tampilkanDataAll();
                }
            } else {
    ...
    public javax.swing.JTable tblPabrik;
    private javax.swing.JTextField txtCari;
    // End of variables declaration//GEN-END:variables

    private void refreshData(){
       Vector<String> tableHeaders = new Vector<String>();
         tableHeaders.add("IdPabrik");
         tableHeaders.add("NamaPabrik");
         tableHeaders.add("Alamat");
         tableHeaders.add("NoTelepon");
         
        Vector  data = p.Load();
        if (data!=null){
            tblPabrik.setModel(new DefaultTableModel(data, tableHeaders));
    ...
    private void deleteData(){
        if(tblPabrik.getSelectedRow()<0)
            ...
            if(konfirm == JOptionPane.YES_OPTION){
                String IdBarang = String.valueOf(tblPabrik.getValueAt(tblPabrik.getSelectedRow(), 0));
                p.delete(Integer.parseInt(IdBarang)); 
            }
            refreshData();
        }
    }
    ...
    private void posisipergi(int p) {
        tblPabrik.setRowSelectionInterval(p, p);
    }
