 ...
 * @author johan
 */
public class frmFakturReturPembelian extends javax.swing.JFrame {
    frmDetailRetur detail = new frmDetailRetur();
    Retur faktur = new Retur();
    public frmFakturReturPembelian() {
        initComponents();
        tampilkanDataAll();
    }
    ...
    public boolean tampilkanDataAll(){
     Vector<String> tableHeader = new Vector<String>();
        tableHeader.add("No Retur");
        tableHeader.add("Nama Toko");
    ...
    private void initComponents() {
        ...
        getContentPane().add(detil, new org.netbeans.lib.awtextra.AbsoluteConstraints(701, 605, -1, -1));
    ...
    private void hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusActionPerformed
        if(JOptionPane.showConfirmDialog(this, "Hapus Data "+tabelfaktur.getValueAt(tabelfaktur.getSelectedRow(), 1).toString())==0&&faktur.delete(Integer.parseInt(tabelfaktur.getValueAt(tabelfaktur.getSelectedRow(), 0).toString()))){
